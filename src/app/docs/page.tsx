  ...
  if (!doc) {
    return (
      <DocsLayout activeSlug="docs">
        <h1 className="text-4xl font-bold mb-2 text-neutral-900">Documentation</h1>
        <p className="text-neutral-700">Welcome to TerminaI documentation. Content is being migrated.</p>
      </DocsLayout>
    );
  }
