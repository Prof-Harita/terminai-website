...
const components = {
  ...
  h2: (props: React.ComponentPropsWithoutRef<'h2'>) => (
    <h2 {...props} className="text-[20px] font-bold mt-10 mb-4 text-white border-b border-white/10 pb-2" />
  ),
  ...
  ul: (props: React.ComponentPropsWithoutRef<'ul'>) => (
    <ul {...props} className="list-disc list-outside ml-6 mb-4 space-y-2 text-[18px] text-white/70" />
  ),
  ol: (props: React.ComponentPropsWithoutRef<'ol'>) => (
    <ol {...props} className="list-decimal list-outside ml-6 mb-4 space-y-2 text-[18px] text-white/70" />
  ),
  ...
  a: (props: React.ComponentPropsWithoutRef<'a'>) => {
    ...
    return <a {...props} className="text-[var(--color-brand-red)] hover:text-red-400 hover:underline font-medium" />;
  },
  blockquote: (props: React.ComponentPropsWithoutRef<'blockquote'>) => (
    <blockquote {...props} className="border-l-4 border-red-500 pl-4 py-2 my-4 bg-white/5 text-white/70 italic" />
  ),
  code: (props: React.ComponentPropsWithoutRef<'code'>) => (
    <code {...props} className="bg-white/10 text-red-300 rounded px-1.5 py-0.5 text-[18px] font-mono" />
  ),
  pre: (props: React.ComponentPropsWithoutRef<'pre'>) => (
    <pre {...props} className="bg-black text-white/90 border border-white/10 rounded-lg p-4 overflow-x-auto mb-6 text-[18px] font-mono">
      {props.children}
    </pre>
  ),
  img: (props: React.ComponentPropsWithoutRef<'img'>) => (
    // eslint-disable-next-line @next/next/no-img-element
    <img {...props} className="rounded-lg border border-white/10 my-6 max-w-full" alt={props.alt || ''} />
  ),
