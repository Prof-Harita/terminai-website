...
You can also use the `--model` flag to specify a particular LLM on startup. For more details, refer to the [configuration documentation](/docs/cli/configuration).
