...
TerminaI includes robust session management features that automatically save your conversation history. This allows you to interrupt your work and resume exactly where you left off, review past interactions, and manage your conversation history effectively.

## Automatic Saving

[Section titled “Automatic Saving”](#automatic-saving)

Every time you interact with TerminaI, your session is automatically saved. This happens in the background without any manual intervention.
...
You can configure how TerminaI manages your session history in your `settings.json` file.
...
```
{  "general": {    "sessionRetention": {      "enabled": true,      "maxAge": "30d", // Keep sessions for 30 days      "maxCount": 50 // Keep the 50 most recent sessions    }  }}
```
