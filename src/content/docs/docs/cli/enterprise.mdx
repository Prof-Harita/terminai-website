...
You can significantly enhance security by controlling which tools the LLM can use. This is achieved through the `tools.core` and `tools.exclude` settings. For a list of available tools, see the [Tools documentation](/docs/tools).
