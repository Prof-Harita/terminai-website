...
This document describes the `save_memory` tool for the TerminaI.

## Description

[Section titled “Description”](#description)

Use `save_memory` to save and recall information across your TerminaI sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with the TerminaI

[Section titled “How to use save\_memory with the TerminaI”](#how-to-use-save_memory-with-the-terminai)

The tool appends the provided `fact` to a special `GEMINI.md` file located in the user’s home directory (`~/.terminai/GEMINI.md`). This file can be configured to have a different name.
...
```
save_memory(fact="The project I'm currently working on is called 'terminai'.")
```
