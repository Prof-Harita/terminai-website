---
title: "Multi-LLM Provider Support Architecture"
description: "TerminaI documentation for Multi-LLM Provider Support Architecture"
---
...
| Variable                   | Purpose                                     |
| -------------------------- | ------------------------------------------- |
| `TERMINAI_GEMINI_BASE_URL` | Override LLM API base URL (validated)    |
